...
export default function EmailVerifyIcon({
  size = 32,
  className,
  ...props
}: Props) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M24,16c-4.4,0-8,3.6-8,8s3.6,8,8,8s8-3.6,8-8S28.4,16,24,16z M27.7,22.7l-4,4C23.5,26.9,23.3,27,23,27s-0.5-0.1-0.7-0.3 l-2-2c-0.4-0.4-0.4-1,0-1.4s1-0.4,1.4,0l1.3,1.3l3.3-3.3c0.4-0.4,1-0.4,1.4,0S28.1,22.3,27.7,22.7z" />
      <g>
